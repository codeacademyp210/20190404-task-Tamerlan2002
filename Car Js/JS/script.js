...
// class CarObj {
//     constructor(manu, model, release) {
//         this.manu = manu;
//         this.model = model;
//         this.release = release;
//     }
...
function formValidation() {
    ...
    if (yearIn.value <= 1769) {
        alert("Insert number above than 1769");
        return false
    }
...
function displayCars() {
    ...
    delbtn.addEventListener("click", function () {
        ...
        if (typeof (Storage) !== "undefined") {
            localStorage.setItem(carsArr, newLi.textContent);
            document.getElementById("result").innerHTML = localStorage.getItem(newLi.textContent);
        } else {
